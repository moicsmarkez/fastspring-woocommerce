...
class WC_Gateway_FastSpring_Builder {
   ...
   * @return float
   */
  public static function get_discount_item_amount($amount) {
  ...
  public static function get_cart_items() {
    ...
    foreach (WC()->cart->cart_contents as $cart_item_key => $values) {
      ...
      $item = array(
        'product' => get_post_meta($product->get_id(), '_producto_fastspring', true),
        //'path' => get_post_meta($product->get_id(), '_producto_fastspring', true),
